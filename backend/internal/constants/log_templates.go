...
const (
	...
	LogMoodDeleted        = "Mood moved to trash with deleted_at and seven-day retention"
	LogMoodTrashListed    = "Mood trash list requested"
	LogMoodRestored       = "Mood restored from trash with deleted_at cleared"
	LogMoodPurged         = "Mood expired trash purged"
