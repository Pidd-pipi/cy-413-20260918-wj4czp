...
const (
	...
	LogMoodDeleted        = "Mood moved to recycle trash with 7-day retention"
	LogMoodTrashListed    = "Mood recycle trash list requested"
	LogMoodRestored       = "Mood restored from recycle trash with original record_date"
	LogMoodTrashPurged    = "expired Mood records purged from recycle trash"
