...
export interface Mood {id:number;user_id:number;mood_level:number;mood_tags:string;note:string;record_date:string;deleted_at?:string|null;created_at:string}
export interface MoodTrashItem extends Mood {expires_at:string}
